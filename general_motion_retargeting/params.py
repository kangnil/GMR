...
ROBOT_XML_DICT = {
    ...
    "27dof_v37_3_fullmesh": ASSET_ROOT / "27dof_v37_3_fullmesh" / "robot.mjcf",
    "unitree_g1_with_hands": ASSET_ROOT / "unitree_g1" / "g1_mocap_29dof_with_hands.xml",
    "alpha": ASSET_ROOT / "alpha" / "alpha-robot36-4.xml",
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "27dof_v37_3_fullmesh": IK_CONFIG_ROOT / "smplx_to_27dof_v37_3_fullmesh.json",
        "alpha": IK_CONFIG_ROOT / "smplx_to_alpha.json",
...
ROBOT_BASE_DICT = {
    "unitree_g1": "pelvis",
    "27dof_v37_3_fullmesh": "torso_link",
    "alpha": "torso",
